...
export default function SignupCard() {
	...
	const handleGoogleSignup = async () => {
		try {
			...
			showToast("Success", "Successfully signed up with Google!", "success");
			...
			if (userData.setupRequired || !userData.isProfileComplete) {
				...
				showToast("Success", "Welcome to Sociality!", "success");
				setTimeout(() => {
			...
			if (error.message.includes('Popup blocked') || error.message.includes('Popups are blocked')) {
				...
				errorMessage = "Please click the button directly to open Google signup.";
			}
